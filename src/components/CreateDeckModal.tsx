...
export function CreateDeckModal({ modalVisible, toggleModal }: CreateDeckModalProps){
      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <View style={styles.modalViewHeader}>
            <Text style={styles.modalHeaderText}>Criando Deck</Text>
          ...
          <View style={styles.modalContent}>
            ...
            <TextInput style={styles.input} value={deckName} onChangeText={e => setDeckName(e)} placeholder='Digite o nome do seu Deck'/>

            <Pressable onPress={handleCreatedDeck} style={({ pressed }) => [ styles.button, pressed && styles.pressed]}>
